...
[9] Therneau T (2022). *A Package for Survival Analysis in R*. R package
version 3.4-0, <https://CRAN.R-project.org/package=survival>.

[10] Terry M. Therneau, Patricia M. Grambsch (2000). *Modeling Survival
Data: Extending the Cox Model*. Springer, New York. ISBN 0-387-98784-3.
